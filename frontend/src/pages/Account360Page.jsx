...
import { RiFileTextLine, RiMailSendLine, RiBoxingLine, RiLightbulbLine, RiFlashlightLine, RiRoadMapLine, RiCloseCircleLine, RiPhoneLine, RiFlowChart } from 'react-icons/ri';
  ...
  return (
    <div className="a360-page page-wrap">
      ...
      <div className="a360-footer glass-card">
        ...
        {onOpenOutreach && (
          <button className="btn-primary" onClick={() => onOpenOutreach(p, analysis)}><RiFlowChart size={13} style={{ verticalAlign: 'middle', marginRight: 5 }} />Outreach Sequence</button>
        )}
