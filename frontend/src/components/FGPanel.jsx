...
function FGStats({ flights }) {
  ...
  const commercial = flights.filter(f => !f.isCargo).length;
  ...
  return (
    <div className="fg-stats">
      ...
      <div className="fg-stats-grid">
        ...
        <div className="fg-stat"><span className="fg-stat-val" style={{ color: '#f59e0b' }}>{cargo}</span><span className="fg-stat-key">CARGO</span></div>
