  ...
  try {
    ...
    res.json({
      ...
      ports: [
        ...
        { name: 'New York/New Jersey',  lat: 40.68,  lng: -74.05,  status: 'moderate',   congestion: 4 },
        ...
        { name: 'Houston',              lat: 29.73,  lng: -95.02,  status: 'clear',      congestion: 3 },
        ...
        { name: 'Oakland',              lat: 37.80,  lng: -122.28, status: 'clear',      congestion: 3 },
        { name: 'Baltimore',            lat: 39.27,  lng: -76.58,  status: 'clear',      congestion: 2 },
        { name: 'Miami',                lat: 25.77,  lng: -80.18,  status: 'clear',      congestion: 3 },
        // International ports
        { name: 'Shanghai',             lat: 31.22,  lng: 121.47,  status: 'clear',      congestion: 3 },
        { name: 'Ningbo-Zhoushan',      lat: 29.87,  lng: 121.55,  status: 'clear',      congestion: 3 },
        { name: 'Yantian/Shenzhen',     lat: 22.57,  lng: 114.27,  status: 'clear',      congestion: 3 },
        ...
        { name: 'Ho Chi Minh City',     lat: 10.77,  lng: 106.72,  status: 'clear',      congestion: 3 },
        { name: 'Hong Kong',            lat: 22.29,  lng: 114.17,  status: 'clear',      congestion: 3 },
        { name: 'Jebel Ali',            lat: 25.01,  lng: 55.06,   status: 'clear',      congestion: 2 },
        { name: 'Colombo',              lat: 6.94,   lng: 79.84,   status: 'clear',      congestion: 2 },
        { name: 'Rotterdam',            lat: 51.95,  lng: 4.13,    status: 'clear',      congestion: 2 },
        { name: 'Antwerp',              lat: 51.26,  lng: 4.40,    status: 'clear',      congestion: 2 },
